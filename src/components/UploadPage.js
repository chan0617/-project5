		...
		<div id="body">
			<div id="load-container">
				<Form name="uploadForm" onFinish={onSubmit}>
					...
					<Divider />
					<Form.Item label={<div className="upload-label">작가명</div>} name="seller" rules={[{ required: true, message: "판매자명을 입력해주세요" }]}>
						<Input className="upload-name" size="large" placeholder="판매자명을 입력해주세요" />
					</Form.Item>
					<Divider />
					<Form.Item label={<div className="upload-label">작품명</div>} rules={[{ required: true, message: "상품명을 입력해주세요" }]} name="name">
					...
					<Divider />
					<Form.Item label={<div className="upload-label">작품설명</div>} rules={[{ required: true, message: "상품설명을 입력해주세요" }]} name="description">
